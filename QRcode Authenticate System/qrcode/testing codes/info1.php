...
//Doing reverse geolocation sharing using Lat and Long
						     ...
						     {                                         
   						       ...
   						       while($row = mysqli_fetch_array($sql)) 
						      {
							   echo'
                                    ...
                                    <br />
                                    <center>
                                   <img id="HPlogo" src="logo.png" alt="" style="height:120px;width:120px;border-width:0px;"/>
                                    </center>          
                                    </div>
                                    <div id="Content">
...
<div style="width:70%; height:auto; border-bottom-style: solid; border-bottom-width: thin; border-bottom-color: #666666; background-color:#84e371">
                   <img id="validicon" alt="" src="logo_successful.png" style="height:auto; width:30%; text-align:center;"/>
                                    <br />
...
<span id="PinText" style="color:#FFFFFF; font-family: Arial; text-align:center; font-size: x-large;">PIN :</span>
<span id="NoPin" style="color:#FFFFFF; font-family: Arial; text-align:center; font-size: x-large;">'.$row['announce'].'</span>
				                     <br/>
<span id="RegionText" style="color:#FFFFFF; font-family: Arial; text-align:center; font-size: x-medium;">REGION :</span>
<span id="RegionName" style="color:#FFFFFF; font-family: Arial; text-align:center; font-size: x-medium;">'.$row['build'].'</span>
				                     <br/>

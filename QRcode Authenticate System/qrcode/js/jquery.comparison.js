		   ...
		   // if the button has the class active we have items to compare
	       	if($(this).hasClass('active')){
				...
				for (var i = 0; i < arrayLength; i++) {
					...
					$('.modal-products').append('<div class="product"><img src="'+$(product).find('img').attr('src')+'"/><ul><li><span>Name:&nbsp;&nbsp;'+$(product).data('name')+'</span></li><li><span>Announce:&nbsp;&nbsp;'+$(product).data('announce')+'</span></li><li><span>Battery:&nbsp;&nbsp;'+$(product).data('battery')+'</span></li><li><span>Build:&nbsp;&nbsp;'+$(product).data('build')+'</span></li><li><span>Camera:&nbsp;&nbsp;'+$(product).data('camera')+'</span></li><li><span>Chipset:&nbsp;&nbsp;'+$(product).data('chipset')+'</span></li><li><span>Cpu:&nbsp;&nbsp;'+$(product).data('cpu')+'</span></li><li><span>Os:&nbsp;&nbsp;'+$(product).data('os')+'</span></li><li><span>Performance:&nbsp;&nbsp;'+$(product).data('performance')+'</span></li></ul><li><span>Sim:&nbsp;&nbsp;'+$(product).data('sim')+'</span></li><li><span>Technology:&nbsp;&nbsp;'+$(product).data('technology')+'</span></li><li><span>Weight:&nbsp;&nbsp;'+$(product).data('weight')+'</span></li><li><span>Price:&nbsp;&nbsp;'+$(product).data('price')+'</span></li></div>');
